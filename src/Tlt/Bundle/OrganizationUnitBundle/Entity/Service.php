 ...
 * @ORM\Entity
 * @ORM\Table(
 *      name="tlt_organization_unit_service"
 * )
 * @ORM\Entity(repositoryClass="Tlt\Bundle\OrganizationUnitBundle\Entity\Repository\ServiceRepository")
 * @ORM\HasLifecycleCallbacks()
 * @Oro\Loggable
 * @Config(
 *      routeName="tlt_organization_unit_service_index",
 *      routeView="tlt_organization_unit_service_view",
 *      defaultValues={
 *          "dataaudit"={
 *              "auditable"=true
 *          },
