 ...
 * @ORM\Entity
 * @ORM\Table(
 *      name="tlt_organization_unit_equipment",
 * )
 * @ORM\HasLifecycleCallbacks()
 * @Oro\Loggable
 * @Config(
 *      routeName="tlt_organization_unit_equipment_index",
 *      routeView="tlt_organization_unit_equipment_view",
 *      defaultValues={
 *          "dataaudit"={
 *              "auditable"=true
 *          },
...
class Equipment
{
     ...
     * @var Service
     *
     * @ORM\ManyToOne(targetEntity="Tlt\Bundle\OrganizationUnitBundle\Entity\Service")
    ...
    {
        $this->createdAt = $this->createdAt ? $this->createdAt : new \DateTime('now', new \DateTimeZone('Europe/Bucharest'));
    }
